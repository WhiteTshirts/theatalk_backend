...
ActiveRecord::Schema.define(version: 20210308111352) do
  ...
  create_table "dm_messages", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "user_id"
    t.integer "dm_id"
    t.string "message"
    t.datetime "created_at", null: false
  ...
  create_table "room_histories", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.bigint "user_id"
    t.bigint "room_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "user_dms", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "user_id"
    t.integer "dm_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
